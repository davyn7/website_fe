    ...
    <div className='flex flex-col justify-center'>
      ...
      <div style={containerStyle}>
        <Link href="/new/journey">
          ...
          >
            <ImageSrc style={{ backgroundImage: `url('/davyngrad1.jpg')` }} />
        ...
        <a href="https://www.joinmasa.ai">
          ...
          >
            <ImageSrc style={{ backgroundImage: `url('/davynmasa1.jpg')` }} />
            <ImageBackdrop className="MuiImageBackdrop-root" />
            <Image>
              <Typography
                component="span"
        ...
        <Link href="/new/research">
          ...
          >
            <ImageSrc style={{ backgroundImage: `url('/davynmasa2.png')` }} />
            <ImageBackdrop className="MuiImageBackdrop-root" />
            <Image>
              <Typography
                component="span"
      ...
      <div style={containerStyle}>
        <Link href="/new/services">
          ...
          >
            <ImageSrc style={{ backgroundImage: `url('/davynmasa.jpg')` }} />
            <ImageBackdrop className="MuiImageBackdrop-root" />
            <Image>
              <Typography
                component="span"
        ...
        <Link href="/new/products">
          ...
          >
            <ImageSrc style={{ backgroundImage: `url('/davynioh.jpg')` }} />
            <ImageBackdrop className="MuiImageBackdrop-root" />
            <Image>
              <Typography
                component="span"
        ...
        <Link href="/new/ratecard">
          ...
          >
            <ImageSrc style={{ backgroundImage: `url('/davynindo.jpg')` }} />
            <ImageBackdrop className="MuiImageBackdrop-root" />
            <Image>
              <Typography
                component="span"
        ...
        <Link href="/new/contact">
          ...
          >
            <ImageSrc style={{ backgroundImage: `url('/davyndog.jpg')` }} />
            <ImageBackdrop className="MuiImageBackdrop-root" />
            <Image>
              <Typography
                component="span"
